...
| происхождение | `--by-source` | источник начинается с доверенного префикса; пустой список — по умолчанию: `Raw/…` и ветки вики с описанием системы | `verify.trusted_sources` |
